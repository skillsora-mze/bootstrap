...
load_config() {
    ...
    local required=(KUBERNETES_MINOR KUBERNETES_PATCH KIND_VERSION K9S_VERSION KUBECTX_VERSION HELM_VERSION SAM_CLI_VERSION SAM_CLI_SHA256_AMD64 SAM_CLI_SHA256_ARM64 RANCHER_DESKTOP_VERSION)
    local var
